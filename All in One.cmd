...
REM  Verifie uniquement la cle registre DisableSR (SystemRestore.GetDiskList WMI n'existe pas)
REM  Si DisableSR=1, SR est desactive globalement et la creation de point echouera : on reactive
